...
class SearchPhotosPagingSource(private val flickrApi: FlickrApi, private val searchText: String) : PagingSource<Int, PhotoX>() {

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, PhotoX> {
        val page = params.key ?: 1
        return try {
            val response = flickrApi.getSearchPhotos(searchText = searchText).body()!!.photos.photo
